...
[joergklein/fldigi][1] is a [Docker][2].base image for Fldigi.

[1]: https://hub.docker.com/r/joergklein/fldigi
[2]: https://docker.com

### Clone the Repository and run Fldigi

```sh
git clone https://github.com/joergklein/docker-fldigi.git
./run
fldigi &
```
...
```sh
docker build -t joergklein/fldigi[<Tag>] .
./run
fldigi &
```
